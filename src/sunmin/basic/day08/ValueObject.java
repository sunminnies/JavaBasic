...
public class ValueObject {
    public static void main(String[] args) {
        // setter / getter
        // 기본적으로 클래스 멤버변수의 접근지정자는 private으로 선언하는것이 좋음 - datahiding 차원
...
//        sj.mat = 32;
        ...
        // OOP(Object Oriented Programming)에서는 객체의 변수를 외부에서 직접 접근하는 것을 권장하고 있지 않음
        // 즉, 데이터는 외부에서의 접근을 막는다는 의믜임
        // 만일 접근하려면 객체에서 공개한 메서드를 통해서만 가능하도록 유도함 - setter / getter
...
class C {
    ...
    public void setName(String name) { // sunmin_ set변수명의 첫글자는 대문자 사용
        this.name = name;
    }
    ...
    // getter 정의 : public 반환유형 get변수명() // sunmin_반환유형은 변수의 자료타입
