...
public class Overloading {
    public static void main(String[] args) {
        ...
        // 메서드의 서명을 다르게해서 한 클래스에서 같은 이름의 메서드를 2개 이상 선언하는 것

        // 정수,실수 매개변수를 2개 또는 3개를 이용해서 간단한 덧셈을 수행하는 프로그램 작성
...
class NonOver {
    ...
    // 다형성이 적용되지 않으면 생성한 메서드마다 이름을 제각각 정해야함
    // 개발자가 일일이 기억해서 사용해야 하는 번거로움 초래
}
...
class Over {
    ...
    // 다형성을 적용하면 기능은 달라도 메서드 이름이 통일되므로 개발자가 메서드를 일일이 외울 필요 없음
    // 단지, 메서드를 어떻게 호출할지만 알고 있으면 됨
}
