...
public class SungJukV3 {
	...
	public static void main(String[] args) {
		...
		// 뭘 입력해야 할지, 입력시 어떤 기능이 실행되는지 알 수 없음

		// System.out.print("작업을 선택하세요 : (1,2,3,4,5,0) ");
		// 뭘 입력해야 될지는 알지만, 입력시 어떤 기능이 실행되는지 알 수 없음
		while (true) {
			String displaymenu = "-------------------    \n" + " 성적 프로그램 v3      \n" + "-------------------    \n"
					+ " 1. 성적데이터 입력    \n" + " 2. 성적데이터 조회    \n" + " 3. 성적데이터 상세조회\n" + " 4. 성적데이터 수정    \n"
					+ " 5. 성적데이터 삭제    \n" + " 0. 성적데이터 종료    \n" + "-------------------    \n" + " 작업을 선택하세요 :  ";
			...
			case "1":
				...
				break;
			case "2":
				System.out.println("성적데이터 조회 ");
				break;
			case "3":
				System.out.println("성적데이터 상세조회 ");
				break;
			case "4":
				System.out.println("성적데이터 수정 ");
				break;
			case "5":
