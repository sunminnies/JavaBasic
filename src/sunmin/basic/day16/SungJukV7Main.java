...
import sunmin.basic.sungjuk.SungJukServiceV2;
import sunmin.basic.sungjuk.SungJukServiceV2Impl;
...
public class SungJukV7Main {
    ...
    // 성적처리 프로그램 V7 - ArrayList + 텍스트기반 스트림 + 직렬화
    // 입력한 성적데이터를 직렬화를 통해 텍스트 기반 파일에 저장
    // 따라서 프로그램 종료시 입력했던 데이터는 그대로 유지됨
    // SungJukServiceV3
    // initSungJuk, saveSungJuk (파일처리/직렬화 관련) 추가
