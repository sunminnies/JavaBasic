...
public class JDBCMember {
    public static void main(String[] args) {
        ...
        // 테이블 컬럼 구성 : 아이디userid, 비밀번호passwd, 이름name, 생년월일birth, 성별gender, 본인확인이메일email, 휴대전화hp
        // 자동입력컬럼 : 회원번호mbno(PK), 가입일regdate

        // 회원가입 테이블 생성
        // create table NMember (mbno int primary key auto_increment,
        ...
        // values ('abc123','987xyz','홍길동','2021-04-21',0,'abc123@987xyz.com','010-1234-5678');
        ...
        // 데이터 수정 테스트
        // update NMember set name = "전지현", birth = "2020-04-21" where mbno = 1;

        // 데이터 삭제 테스트
        // delete from NMember where mbno = 1;

        // 테이블 생성
//        String member = " create table NMember (mbno int primary key auto_increment, userid varchar(18) not null, " +
//                " passwd varchar(18) not null, name varchar(10) not null, " +
//                " birth varchar(10) not null, gender int not null, email varchar(50) not null, " +
//                " hp varchar(15) not null, regdate datetime default current_timestamp ";
//
//        try(Connection conn = jdbc.openConn();
//            Statement stmt = conn.createStatement();
//        ) {
//            boolean isOK = stmt.execute(member);
//            if (isOK) System.out.println("멤버 테이블 생성!");
//        } catch (Exception ex) {
//            ex.printStackTrace();
//        }
