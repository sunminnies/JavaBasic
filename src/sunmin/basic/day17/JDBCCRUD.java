...
public class JDBCCRUD {
    public static void main(String[] args) throws ClassNotFoundException {
        // ex) playground 데이터베이스에 books 테이블을 생성하고 새로운 도서정보를 입력하는 프로그램을 작성
        ...
        // JDBC 관련 sql 정의
        String books = "create table books (bookid int, bookname varchar(30), publish varchar(30), price int)";
        String newbooksql = " insert into books values (99999, 'hello, java', 'oracle', 10000) ";
        ...
        try (Connection conn = DriverManager.getConnection(url, usr, pwd);
            ...
            // 지정한 SQL을 실행하고 결과를 받아옴 (구문이 실행되었는지 여부 확인)
            // 단, insert, update, delete 실행 시 사용!
        ...
        String sql = String.format(newbooksql2,bookid,bookname,publish,price);
