...
public class EX01 {
	public static void main(String[] args) {
		...
		// sunmin_ +연산자는 차변 대변 합쳐서 표현할 때 사용(연결 연산자)
		// sunmin_ 자동으로 문자로 형변환이 일어남
		// sunmin_ 정수로 연산했기 때문에 결과 값이 정수로 도출됨 (0 이하 자리 버림)
		// 예상값 : 1, 실제값 : 0.0
		...
		// 6.
		// sunmin_ x, y, result는 위에 사용한 변수와 중복이라서 바꿈
		double xx = 2.5;
		double yy = 1.5;
		int m = 18;
		int n = 4;
