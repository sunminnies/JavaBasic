...
public class Condition {
	...
	public static void main(String[] args) {
		...
		// ex) 1~100사이 정수 중 짝수라면 "짝수입니다"를 홀수라면 "홀수입니다"라고 출력하세요
		for (int i = 0; i <= 100; ++i) {
			if (i % 2 == 0)
		...
		// 사용자가 연봉salary과 결혼여부isMarried(0/1)를 입력하면 다음의 세금율에 의해 납부해야 할 세금tax을 계산하는 프로그램을
		// 작성하세요
		...
		salary = sc.nextInt();
		System.out.print("결혼여부는?(0-아니오, 1-예)");
