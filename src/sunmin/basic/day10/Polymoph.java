...
public class Polymoph {
    public static void main(String[] args) {
        ...
        // 상속관계에 있는 부모/자식 클래스/인터페이스간에도 서로 형변환이 가능
        // 이러한 형변환을 업캐스팅/다운캐스팅이라 함
        // 자식클래스의 타입이 부모클래스의 타입으로 바뀌는 것을 '업캐스팅'이라 하고,
        // 부모클래스의 타입이 자식클래스의 타입으로 바뀌는 것을 '다운캐스팅'이라 함
        ...
        // 여전히, draw 메서드 호출시 동일한 클래스 타입을 사용해야함
        ...
        // 동적바인딩을 이용해서 하나의 배열변수에 Line, Circle, Triangle을 저장
...
//        shapes[2].draw();
        ...
        // 바인딩 binding
        // 프로그램에 사용된 구성요소의 실제값 또는 속성을 결정하는 행위
        // 즉, 변수에 값이 저장될때나 함수 호출 시, 실제 함수가 위치한 메모리상의 주소와 연결하는 것을 의미
