...
public class JavaCalendar {
    public static void main(String[] args) {
        // 자바로 시간, 날짜 다루기
        // JDK 1에서 제공한 Date 클래스를 이용해서 날짜, 시간에 대한 처리를 할 수 있지만
        // JDK 1.1에 나온 Calendar 클래스를 이용해서 날짜, 시간에 대한 처리를 수행하는 것을 권장함
        // 하지만, 날짜 처리 시 윤초를 고려하지 않거나 (정확도 낮음)
        // 월을 표시할 때 1부터 표시하지 않고 0부터 표시하는 문제 존재
        // 따라서, 더 나은 성능의 Joda-Time이라는 라이브러리가 JDK 8에서 추가됨
