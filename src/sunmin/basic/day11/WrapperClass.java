...
public class WrapperClass {
    public static void main(String[] args) {
        // Wrapper Class (포장클래스)
        // 프로그램에 따라 기본 자료형의 데이터를 참조자료형으로 바꿔 취급해야할 때가 있음
        // 메서드의 매개변수가 객체형을 요구하면 그에 따라 객체형을 사용해야함
        // 기본자료형 변수를 참조자료형 변수로 변환하는 클래스를 포장클래스라 함
        // int -> Integer, double -> Double
        // char -> Character, boolean -> Boolean

        int a = 123;
        Integer b = new Integer(a); // 박싱 : 기본자료형 변수를 참조자료형 변수로 변환하는 것
