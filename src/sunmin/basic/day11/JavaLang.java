...
public class JavaLang {
    public static void main(String[] args) {
        ...
        // Class 클래스
        // 실행중인 자바 프로그램 내부에 포함된 클래스와 인터페이스 정보를 제공
        // 또한, 동적으로 객체를 생성할수도 있음

        // Math 클래스
        // 다양한 수학적 연산을 위한 메서드 제공
        // 모든 메서드가 static 이기 때문에 객체 생성 없이 바로 메서드 호출가능
        ...
        // ex) 3.1415926에서 round 메서드를 이용해서 소수점 두번재 자리까지 구하려면?
