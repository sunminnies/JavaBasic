...
public class Operators {
	public static void main(String[] args) {
		...
		// 여러개의 논리식 중에 어떤 식에 의해 참거짓이 확정되면 나머지 논리식을 평가하지 않음
		...
		int result3 = ++a + 10; // a값을 증가시킨 후 연산에 적용 (전치연산)
		int result4 = b++ + 10; // a값을 연산에 적용한 후 값 증가 (후치연산)
